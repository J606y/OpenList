...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems := []model.SettingItem{
		...
		{Key: conf.VideoTypes, Value: "mp4,mkv,avi,mov,rmvb,webm,flv,m3u8,ts,m2ts", Type: conf.TypeText, Group: model.PREVIEW, Flag: model.PRIVATE},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.ProxyDownloadConcurrency, Value: "6", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
	}
